...
{
    public class VMheritageOperations : ViewModelBase
    {
        ...
        #endregion
        public VMheritageOperations(Banco b)
        {
        ...
        private async Task ejecutarAltaEmailDestino()
        {
            ...
            Banco b = ServicioBanco.getInstancia().getByNombre(VariablesGlobales.heritage);
