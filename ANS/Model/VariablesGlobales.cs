...
namespace ANS.Model
{
    public static class VariablesGlobales
    {
        ...
        public static TimeSpan horaCierreSantanderHENDERSON_TANDA1_TXT = new TimeSpan(7, 5, 0);

        public static TimeSpan horaCierreSantanderHENDERSON_TANDA1_EXCEL = new TimeSpan(7,10,0);

        public static TimeSpan horaCierreSantanderHENDERSON_TANDA2_TXT = new TimeSpan(14, 20, 0);
