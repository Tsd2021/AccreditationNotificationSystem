...
namespace ANS.Model.Jobs.SCOTIABANK
{
    ...
    public class CombinarTxtScotiabankPorDivisaMontevideo : IJob
    {
        ...
        private async Task CombinarArchivosPorDivisa(string divisaCodigo, string monedaCodigo)
        {
            try
            {
                // En PRODUCCIÓN: Leer de la carpeta donde ANS genera los archivos (MONTEVIDEO)
                ...
                string basePath = ConfiguracionGlobal.Rutas.ScotiabankMontevideo;
                ...
                ServicioLog.instancia.WriteInfo(
                    ...
                    "SCOTIABANK | CombinarTxtScotiabankPorDivisaMontevideo | Inicio");
                ...
                if (!Directory.Exists(folderPath))
                {
                    ...
                    ServicioLog.instancia.WriteInfo(
                        ...
                        "SCOTIABANK | CombinarTxtScotiabankPorDivisaMontevideo | Creación Carpeta");
                }
                ...
                ServicioLog.instancia.WriteInfo(
                    ...
                    "SCOTIABANK | CombinarTxtScotiabankPorDivisaMontevideo | Paso 1");
                ...
                ServicioLog.instancia.WriteInfo(
                    ...
                    "SCOTIABANK | CombinarTxtScotiabankPorDivisaMontevideo | Paso 2");
                ...
                ServicioLog.instancia.WriteInfo(
                    ...
                    "SCOTIABANK | CombinarTxtScotiabankPorDivisaMontevideo | Paso 3");
                ...
                ServicioLog.instancia.WriteInfo(
                    ...
                    "SCOTIABANK | CombinarTxtScotiabankPorDivisaMontevideo | Combinación");
                ...
                if (archivoTSD != null && File.Exists(archivoTSD))
                {
                    ServicioLog.instancia.WriteInfo(
                        ...
                        "SCOTIABANK | CombinarTxtScotiabankPorDivisaMontevideo | Lectura TSD");
                        ...
                        if (linea.Length == 875)
                        {
                            ...
                            catch (Exception ex)
                            {
                                ServicioLog.instancia.WriteInfo(
                                    ...
                                    "SCOTIABANK | CombinarTxtScotiabankPorDivisaMontevideo | Error");
                            }
                        }
                        else
                        {
                            ...
                            if (lineasInvalidasTSD <= 3) // Log solo las primeras 3 inválidas
                            {
                                ServicioLog.instancia.WriteInfo(
                                    ...
                                    "SCOTIABANK | CombinarTxtScotiabankPorDivisaMontevideo | Advertencia");
                            }
                        }
                    }
                    ...
                    ServicioLog.instancia.WriteInfo(
                        ...
                        "SCOTIABANK | CombinarTxtScotiabankPorDivisaMontevideo | Paso 1 Completado");
                }
                else
                {
                    ServicioLog.instancia.WriteInfo(
                ...
                if (archivoTanda2 != null && File.Exists(archivoTanda2))
                {
                    ServicioLog.instancia.WriteInfo(
                        ...
                        "SCOTIABANK | CombinarTxtScotiabankPorDivisaMontevideo | Lectura Tanda 2");
                    ...
                    ServicioLog.instancia.WriteInfo(
                        ...
                        $"Total acumulado: {totalImporte:N0}",
                        "SCOTIABANK | CombinarTxtScotiabankPorDivisaMontevideo | Paso 2 Completado");
                }
                else
                {
                    ServicioLog.instancia.WriteInfo(
                ...
                if (archivoDiaADia != null && File.Exists(archivoDiaADia))
                {
                    ServicioLog.instancia.WriteInfo(
                        ...
                        "SCOTIABANK | CombinarTxtScotiabankPorDivisaMontevideo | Lectura Día a Día");
                    ...
                    ServicioLog.instancia.WriteInfo(
                        ...
                        $"Total acumulado: {totalImporte:N0}",
                        "SCOTIABANK | CombinarTxtScotiabankPorDivisaMontevideo | Paso 3 Completado");
                }
                else
                {
                    ServicioLog.instancia.WriteInfo(
                ...
                if (archivoTSDInfo != null)
                {
                    ...
                    ServicioLog.instancia.WriteInfo(
                        ...
                        "SCOTIABANK | CombinarTxtScotiabankPorDivisaMontevideo | Extracción");
                }
                ...
                ServicioLog.instancia.WriteInfo(
                    ...
                    "SCOTIABANK | CombinarTxtScotiabankPorDivisaMontevideo | Generación");
                ...
                ServicioLog.instancia.WriteInfo(
                    ...
                    "SCOTIABANK | CombinarTxtScotiabankPorDivisaMontevideo | Éxito");
            }
            catch (Exception ex)
            {
                ServicioLog.instancia.WriteLog(ex, "Scotiabank", $"Combinar TXT Montevideo {divisaCodigo}");
                throw;
            }
        ...
        /// Ejemplo: "26-11-2025-14-50-UYU3295000-AcreditacionTecnisegurMont.txt"
        /// </summary>
